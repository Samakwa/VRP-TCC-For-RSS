...
def create_data_model():
  ...
  capacities = [  10000000, 10000000,10000000,10000000,10000000,10000000,10000000,10000000,10000000,10000000,
...
def print_solution(data, manager, routing, assignment):
    ...
    for vehicle_id in range(data['num_vehicles']):
        ...
        time = ((route_distance) / speed) +6+ ((route_load/20000) * 0.5)
        plan_output += 'Time of the route: {0}h\n'.format(time)
        if route_load > 9250000:
            print ("Vehicle Category:", "A")
        elif (route_load <4650000) and (route_load > 2500250):
            print("Vehicle Category:", "B")
        elif(route_load >1) and route_load < 2500250:
